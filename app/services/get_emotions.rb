...
class GetEmotions
  ...
  def call
    RestClient.post 'https://api.projectoxford.ai/emotion/v1.0/recognize', { "url": @url }, { headers: { Content_Type: application/json, Ocp-Apim-Subscription-Key: Rails.application.secrets.ms_subscription_key } }
